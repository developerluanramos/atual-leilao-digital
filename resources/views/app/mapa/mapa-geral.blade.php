...
<body>
    <div class="header">
        <br><br><br><br>
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYl3aVkWky8GGlkFjXqJEYLw_LvKM082YxEw&s" alt="" style="width: 150px; height: 170px;">
        <h1 class="text-uppercase">ATUAL LEILÕES E EVENTOS LTDA</h1>
        <br><br><br><br><br><br><br><br>
        <h1 class="text-uppercase">{{$leilao->descricao}}</h1>
        <br><br>
        <h1 style="color: #1e32ec">{{$titulo ?? 'BOOK DO LEILÃO'}}</h1>
        <br><br>
        <p>
    ...
    <div class="footer">
        <p>Atual Leilões</p>
        <p>Desenvolvido e mantido por KOLARES TI - ENGENHARIA DE SOFTWARE ÁGIL</p>
        <p>documento emitido por <b>{{Auth::user()->name}} </b> em <b>{{date('d/m/Y h:i:s')}}</b></p>
    </div>

    <div class="page-break"></div>

    @include('app.mapa.lote-a-lote', ['leilao' => $leilao])

    <div class="page-break"></div>

    @include('app.mapa.media-raca', ['leilao' => $leilao, 'mediasRaca' => $mediasRaca])

    <div class="page-break"></div>

    @include('app.mapa.media-especie', ['leilao' => $leilao, 'mediasEspecie' => $mediasEspecie])

    <div class="page-break"></div>

    @include('app.mapa.ranking-vendedor', ['leilao' => $leilao, 'rankingVendedores' => $rankingVendedores])
