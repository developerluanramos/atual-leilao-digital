...
@section('content')
    ...
    <div class="border-b border-gray-200 dark:border-gray-700">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
            ...
            <li class="me-2">
                @if($aba === 'lotes')
                    <a href="{{route('leilao.show', ['uuid' => $leilao->uuid, 'aba' => 'lotes'])}}"  class="inline-flex items-center justify-center p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group" aria-current="page">
                ...
                @else
                    <a href="{{route('leilao.show', ['uuid' => $leilao->uuid, 'aba' => 'lotes'])}}"  class="inline-flex items-center justify-center p-4 text-grey-600 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group" aria-current="page">
            ...
            <div class="flex flex-wrap -mx-3 mb-2">
                <div class="w-full md:w-3/12 px-3 mb-6 md:mb-0">
                    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">{{$leilao->leiloeiro->nome}}</p>
                    </div>
                </div>
                <div class="w-full md:w-3/12 px-3 mb-6 md:mb-0">
                    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">{{$leilao->promotor->nome}}</p>
                    </div>
                </div>
                <div class="w-full md:w-3/12 px-3 mb-6 md:mb-0">
                    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">{{count($leilao->lotes)}}</p>
                    </div>
                </div>
                <div class="w-full md:w-3/12 px-3 mb-6 md:mb-0">
                    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
