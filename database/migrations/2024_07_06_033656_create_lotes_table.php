...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('lote', function (Blueprint $table) {
            ...
            $table->decimal('quantidade_macho', 12, 2)->nullable(); // -- desconsiderar
            $table->decimal('quantidade_femea', 12, 2)->nullable(); // -- desconsiderar
            $table->decimal('quantidade_outro', 12, 2)->nullable(); // -- desconsiderar
